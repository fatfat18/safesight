...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="">
        ...
        <div class="border-1 ">
            @if (Route::has('login'))
                <div class=" flex justify-center border-8 border-indigo-500 p-6 ">
                    @auth
                        <a href="{{ url('/dashboard') }}" class="text-sm text-gray-700 dark:text-gray-500 underline">Dashboard</a>
                    @else
                        <a href="{{ route('login') }}" class="text-2xl text-indigo-500 ">LOGIN</a>

                        @if (Route::has('register'))
                            <a href="{{ route('register') }}" class="ml-4 text-2xl text-indigo-500 ">REGISTER</a>
                        @endif
                    @endauth
                </div>
            @endif
    ...
    <svg class="" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 250 250">
